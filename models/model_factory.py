...
from spuco.models import MLP, Bert, DistilBert, lenet
...
def model_factory(arch: str, input_shape: Tuple[int, int, int], num_classes: int, pretrained: bool = True, hidden_dim: Optional[int] = None, mult_layer: bool=False):
    """
